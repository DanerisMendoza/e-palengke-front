    ...
    <v-container>
        <v-card class="mt-2 pl-2 pr-2">
            <v-form ref="myForm" @submit.prevent="submit">
                ...
                <v-row>
                    <v-col cols="12">
                        <v-btn v-if="SELECTED_USER_ROLE_DETAILS !== null" @click="home" class="float-right">
                            <v-icon>mdi-home</v-icon></v-btn>
                        <v-btn v-if="SELECTED_USER_ROLE_DETAILS !== null" @click="gps" class="float-right">
                ...
                <v-row v-if="SELECTED_USER_ROLE_DETAILS === 3">
                    <v-col cols="4" class="mt-2">
                        <v-text-field v-model="storeName" label="Enter Your Store Name:"
                            :rules="rules.required"></v-text-field>
                    </v-col>
                    <v-col cols="4" class="mt-2">
                        <v-text-field v-model="storeAddress" label="Enter Your Store Address:"
                            :rules="rules.required"></v-text-field>
                    </v-col>
                    <v-col cols="4">
                        <v-autocomplete v-model="selected_store_type_detail" :items="STORE_TYPE_DETAIL" item-text="name"
                            item-value="id" label="SELECT STORE TYPE" auto-select-first chips multiple
                            :rules="rules.required" deletable-chips></v-autocomplete>
                    </v-col>
                </v-row>

                <v-row v-if="SELECTED_USER_ROLE_DETAILS !== null">
                    <v-col cols="12">
                        <v-btn class="float-right" type="submit">Submit</v-btn>
                    </v-col>
                </v-row>
            </v-form>
        </v-card>
